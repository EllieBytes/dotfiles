...
myLib.registerModule "tools/cybersecurity" {
  ...
  config.environment.systemPackages = with pkgs; [
    ...
    powershell dirb sherlock ffuf whatweb netcat hashcat cowpatty hping nikto autopsy responder crunch maltego macchanger
    ettercap amass john subfinder snort dnschef steghide spider reaverwps reaverwps-t6x netexec mimikatz dnsenum bettercap
    wpscan dirstalk dirbuster tcpdump mitm6 burpsuite xss python313Package.scapy netdiscover gemini-cli fierce dnsrecon
    dmitry cewl python313Packages.bloodyad yara nuclei evil-winrm caido bully bed arjun arjun-cnf websploit stegseek
